...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList)
        {
            ...
            if (int.TryParse(searchNumber, out int searchNumberI))
            {
                if (numberList.Contains(searchNumberI))
                {
                    Console.WriteLine($"The number {searchNumberI} is in the list.");
                }
                else
                {
                    Console.WriteLine($"The number {searchNumberI} is not in the list.");
                }
            }
            else
            {
